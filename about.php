...
<html lang="en">
  <head>
    ...
    <link rel = "icon" href ="img/sample_logo.png" type = "image/x-icon">
    <!-- Google Fonts -->
      ...
      <div id="heroCarousel" class="carousel slide carousel-fade" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
          ...
          <div class="carousel-item active">
            ...
            <div class="carousel-container">
              <div class="carousel-content">
                <h2 class="animate__animated animate__fadeInDown">Welcome to <span>Pizza Ala Fiesta</span></h2>
          ...
          <div class="carousel-item">
            ...
            <div class="carousel-container">
              <div class="carousel-content">
                <h2 class="animate__animated animate__fadeInDown mb-0">GROUP 3</h2> <a href="#">@ Web Dev Group 3</a></p>
                <a href="index.php" class="btn-get-started animate__animated animate__fadeInUp scrollto">Get Started</a>
              </div>
            </div>
          </div>
  ...
  <main id="main">
    ...
    <section id="about" class="about">
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-6">
            <h3>Welcome to <strong>Pizza Ala Fiesta</strong></h3>
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-xl-3 col-lg-4 col-md-6" data-wow-delay="0.1s">
            <div class="member">
              <img src="assets/img/team/team-1.jpg" class="img-fluid" alt="" style= " height: 198px; width:auto;">
              <div class="member-info">
                <div class="member-info-content">
                  <h4>Bernadette Lebanon</h4>
                </div>
                <div class="social">
          ...
          <div class="col-xl-3 col-lg-4 col-md-6" data-wow-delay="0.1s">
            <div class="member">
              <img src="assets/img/team/team-2.jpg" class="img-fluid" alt="" style= " height: 198px; width:auto;">
              <div class="member-info">
                <div class="member-info-content">
                  <h4>Reymina Nanaring</h4>
                </div>
                <div class="social">
          ...
          <div class="col-xl-3 col-lg-4 col-md-6" data-wow-delay="0.2s">
            <div class="member">
              <img src="assets/img/team/team-3.jpg" class="img-fluid" alt="" style="height: 198px;width: auto;">
              <div class="member-info">
                <div class="member-info-content">
                  <h4>Charles Mira</h4>
                </div>
           ...
           <div class="col-xl-3 col-lg-4 col-md-6" data-wow-delay="0.2s">
            <div class="member">
              <img src="assets/img/team/team-4.jpg" class="img-fluid" alt="" style="height: 198px;width: auto;">
              <div class="member-info">
                <div class="member-info-content">
                  <h4>Dharient Joy Dagaas</h4>
                </div>
                <div class="social">
                  <a href=""><i class="icofont-twitter" target="_blank"></i></a>
                  <a href="https://github.com/Blparmar007" target="_blank"><i class="fab fa-github"></i></a>
           ...
           <div class="col-xl-3 col-lg-4 col-md-6" data-wow-delay="0.2s">
            <div class="member">
              <img src="assets/img/team/team-5.jpg" class="img-fluid" alt="" style="height: 198px;width: auto;">
              <div class="member-info">
                <div class="member-info-content">
                  <h4>Maricar Santos</h4>
                </div>
                <div class="social">
                  <a href=""><i class="icofont-twitter" target="_blank"></i></a>
                  <a href="https://github.com/Blparmar007" target="_blank"><i class="fab fa-github"></i></a>
