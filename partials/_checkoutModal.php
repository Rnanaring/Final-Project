...
<div class="modal fade" id="checkoutModal" tabindex="-1" role="dialog" aria-labelledby="checkoutModal" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        ...
        <div class="modal-header">
            <h5 class="modal-title" id="checkoutModal">Please enter your concrete details:</h5>
        ...
        <div class="modal-body">
            <form action="partials/_manageCart.php" method="post">
                <div class="form-group">
                    ...
                    <input class="form-control" id="address" name="address" placeholder=" Ex. Sirawan, Toril, Davao City" type="text" required minlength="3" maxlength="500">
                </div>
                <div class="form-group">
                    <b><label for="address1">Province:</label></b>
                    <input class="form-control" id="address1" name="address1" placeholder="Ex. Davao Oriental" type="text">
                </div>
                <div class="form-row">
                    <div class="form-group col-md-6 mb-0">
                        <b><label for="phone">Contact No:</label></b>
                    ...
                    <div class="form-group col-md-6 mb-0">
                        ...
                        <input type="text" class="form-control" id="zipcode" name="zipcode" placeholder="xxxx" maxlength="4">                    
                    </div>
                </div>
                <div class="form-group">
